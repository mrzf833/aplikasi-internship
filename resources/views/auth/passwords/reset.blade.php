                        ...
                        <div class="login-form">
                            <form action="{{ route('password.update') }}" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="email" type="email" class="au-input au-input--full  @error('email') is-invalid @enderror" name="email" value="{{ $email ?? old('email') }}" required autocomplete="email" autofocus>
                                    @error('email')
